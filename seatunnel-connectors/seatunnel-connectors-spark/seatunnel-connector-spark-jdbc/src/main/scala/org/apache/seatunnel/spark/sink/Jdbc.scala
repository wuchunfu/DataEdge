...
class Jdbc extends SparkBatchSink {
  ...
  override def prepare(prepareEnv: SparkEnvironment): Unit = {
    ...
    defaultConfig.put("saveMode", "error")
    defaultConfig.put("useSsl", "false")
    defaultConfig.put("showSql", "true")
    defaultConfig.put("customUpdateStmt", "")
    defaultConfig.put("duplicateIncs", "")
